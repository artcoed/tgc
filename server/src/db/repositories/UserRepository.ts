...
export class UserRepository {
    ...
    async findByTelegramId(telegramId: number): Promise<UserResult | null> {
        const user = await db
            .selectFrom('users')
            .selectAll()
    ...
    async updateByTelegramId(telegramId: number, updates: UpdateUser): Promise<UserResult | null> {
    ...
    async isFullyRegistered(telegramId: number): Promise<boolean> {
